...
<body class="w3-light-grey">
	...
	<div class="w3-row">
		...
		<nav class="w3-col s3 w3-large w3-padding"
			...
			<div class="w3-bar-block">
				<div class="w3-container">
    				<h3 class="w3-padding"><b>고객센터</b></h3>
  				</div>
		...
		<table class="w3-col s9 w3-table-all w3-section">
			<caption class="w3-section w3-wide" style="font: 20px bold;">문의사항</caption>
				...
				<th>
					<form>
				        ...
				        <div class="w3-section">
      					...
      					<button type="submit" class="w3-button w3-block w3-padding-large w3-black w3-margin-bottom">문의하기</button>						
					</form>
				</th>
			</tr>
