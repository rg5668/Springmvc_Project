...
<c:if test="${hotel_code eq '3101' }">
<div class="w3-center"> 
  <a href="bestForm?hotel_code=3101"><img src="<%=request.getContextPath() %>/w3images/a.jpg" style="width:63%"></a>
</div>
</c:if>

<c:if test="${hotel_code eq '3102' }">
<div class="w3-center"> 
  <a href="bestForm?hotel_code=3102"><img src="<%=request.getContextPath() %>/w3images/b.jpg" style="width:63%"></a>
</div>
</c:if>

<c:if test="${hotel_code eq '3103' }">
<div class="w3-center"> 
  <a href="bestForm?hotel_code=3103"><img src="<%=request.getContextPath() %>/w3images/c.jpg" style="width:63%"></a>
</div>
</c:if>
...
<table id="customers" style="margin-top: 20px; text-align: center; width:64%;">
 <tr style="font-size: 13px; text-align: center;">
    <td rowspan="3"><a href="#"><img src="<%=request.getContextPath()%>${b.room_img}" style="width: 120px; height: 100px;"></a></td>
