...
<div class="main">
   ...
   <div class="service-form" align="center">
	...
	<form action="<%=request.getContextPath() %>/member/passfind" name="f" method="post">
	<table class="tab">
		<tr>
        	<td> <input type="text" class="user_id" id="user_id" name="user_id" placeholder=" 아이디">
        	</td></tr>
        
        <tr>
        <td><input type="text" class="name" id="name" name="name" placeholder=" 이름"></td>
        </tr>
        
   	</table>
	<div align="center"></div>
 <button type="submit" name="login" class="w3-button w3-black" style="width: 20%; margin-top: 10px">확인</button>
 </form>
 <div class="btn-u" style="font-size: 12px; margin-top: 10px">
   <div class="w3-button w3-black" style="border-radius: 5px; width: 100px;"><a href="<%=request.getContextPath() %>/loginForm">로그인</a></div>
   <span>|</span>
