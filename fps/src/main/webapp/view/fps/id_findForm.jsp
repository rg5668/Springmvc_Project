...
<div class="main">
   ...
   <div class="service-form" align="center">
	...
	<form action="<%=request.getContextPath() %>/member/idfind" name="f" method="post">
	<table class="tab">
		<tr>
        	<td> <input type="text" class="name" id="name" name="name" placeholder=" 이름">
        	</td></tr>
        
        <tr>
        <td><input type="tel" class="tel" id="tel" name="tel" placeholder=" 연락처"></td>
        </tr>
