...
function doSomething() {
    var url = document.forms[0].elements['room_code'].value;
...
<form  action="hsupdate"  method="post" name="f"  enctype="multipart/form-data">
  
  <div class="w3-display-container w3-container" >
  	<p style="font-size: 20px"><b>객실 수정</b>
  </div>
  ...
  <table style="width:60%" class="w3-display-container w3-container" align="center">
		...
		<tr>
		<td>방이름</td>
		<td><input type="text" name="room_name" id="room_name" value="${hsub.room_name }"></td>
		</tr>
		
		<tr>
		<td>가격</td>
		<td><input type="text" name="price" id="price" value="${hsub.price }"></td>
		</tr>
		
		<tr>
		<td colspan="3"> 	
     	<input type="submit" value="숙소수정" class="w3-button w3-black w3-margin-bottom" style="width: 100%">
     	</td>
     	</tr>
