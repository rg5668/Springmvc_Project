...
public class Hotel4s{
	...
	public String toString() {
		return "Hotel4s [hotel_code=" + hotel_code + ", theme_code=" + theme_code + ", hotel_option1=" + hotel_option1
				+ ", hotel_option2=" + hotel_option2 + ", hotel_name=" + hotel_name + ", hotel_addr=" + hotel_addr
				+ ", area_code=" + area_code + ", hotel_img=" + hotel_img + ", hotel_tel=" + hotel_tel
